...
@section('content-2')
<form id="memberForm" action="{{ env('APP_URL', '127.0.0.1:8000') }}/register" method="POST">
{{ csrf_field() }}
...
<div class="row form-group align-items-center p-5">
    ...
    <div class="col-md-12 my-1" style="margin-top:-5em !important;">
        <div class="row form-group align-items-center p-5">
            ...
            <div class="col-md-3 my-1">
                <input type="text" class="form-control fc-1 font-regular header-10 input-curve p-2" 
                    name="username" placeholder="Member Code">
            </div>
            <div class="col-md-3 my-1">
            ...
            <div class="col-md-6 my-1 ml-5">
                <div class="row form-group align-items-center">
                    ...
                    <div class="col-md-6 my-1">
                        <button id="qr-generator" type="submit" class="btn btn-primary mr-2 btn-rounded-4">
                            Generate QR Code
                        </button>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('input[name="search"]').keyup(function(e) {
            if (e.keyCode == 13) {
                apiCall(
                    "{{ env('API_URL', '127.0.0.1:8001') }}/api/member/" + $(this).val(), 'GET', 
                    '',
                    (data) => {
    ...
    function validateFields() {
        ...
        return (
            ...
            branch_id && status && address && contact && username
        );
